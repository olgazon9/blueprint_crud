...
@loaners_blueprint.route('/loaners', methods=['GET'])
def get_all_loaners():
...
@loaners_blueprint.route('/loaners/<int:loaner_id>', methods=['GET'])
...
@loaners_blueprint.route('/loaners', methods=['POST'])
def create_loaner():
...
@loaners_blueprint.route('/loaners/<int:loaner_id>', methods=['PUT'])
...
@loaners_blueprint.route('/loaners/<int:loaner_id>', methods=['DELETE'])
def delete_loaner(loaner_id):
    ...
    if loaner:
        ...
        return jsonify({'message': 'Loaner not found'}), 404
@loaners_blueprint.route('/search-loaners', methods=['GET'])
